...
<body>
    ...
    <div class="body_3">
        <div class="body_3_1">
        <table width="40%" broder="0" align="center" cellpadding="2" bgcolor="#87CEFA">
            <form name="form_1" method="post" action="main_1.jsp">
                <tr bgcolor="#1E90FF">
                    <td width="20%">数据查询</td>
                    <td width="13%">
                        <select name="select">
                    ...
                    <%--<td width="19%">--%>
                        <%--<div align="center"><a href="newData.jsp"></a></div>--%>
                    <%--</td>--%>
                </tr>
            </form>
    ...
    <table width="70%" broder="0" align="center" cellpadding="2" bgcolor="#87CEFA">
        ...
        <tr bgcolor="#ffffff">
            ...
            <td width="10%">
                <div align="center"><%= rs.getInt(5) %></div>
            </td>
            <td width="20%">
        ...
        <table width="70%" broder="0" align="center" cellpadding="2" bgcolor="#87CEFA">
            <form name="form2" method="get" action="main_1.jsp">
                <tr bgcolor="#D3D3D3">
